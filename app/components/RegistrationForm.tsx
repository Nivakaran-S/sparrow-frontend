...
import { registerUser, UserRegistrationRequest } from "../api/AuthenticationApi";
import AuthenticationError from "../api/AuthenticationApi"
...
export default function RegistrationForm() {
    ...
    const [formData, setFormData] = useState({
        ...
        phoneNumber: '',
        address: '',
        role: 'CUSTOMER' // Updated default role to match Keycloak
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err instanceof AuthenticationError.AuthenticationError) {
            ...
            <div className="min-h-[89vh] relative top-[-20px] flex-col w-[100%] flex items-center justify-center py-[1rem] px-[0px] pt-[70px]">
                <div className="flex items-center justify-center w-[100%] max-w-[500px] h-[60vh] bg-white rounded-[1rem] border-[1.5px] border-[#101010] overflow-hidden">
                    <div className="text-center p-8">
                        ...
                        <h2 className="text-2xl font-bold text-[#101010] mb-4">Registration Successful!</h2>
                        <p className="text-[#1D1D1D] mb-6">Your account has been created successfully. You can now log in with your credentials.</p>
                        <Link 
                            href="/login" 
                            className="py-[0.6rem] px-[1.5rem] bg-[#FFA00A] text-black hover:text-white ring-[0.5px] ring-black rounded-[0.5rem] text-[1rem] cursor-pointer hover:bg-black transition-[0.2s]"
                        >
                            Continue to Login
                        </Link>
                    </div>
        ...
        <div className="min-h-[89vh] relative top-[-20px] flex-col w-[100%] flex items-center justify-center py-[1rem] px-[0px] pt-[70px]">
            <div className="flex items-center justify-center w-[100%] max-w-[600px] bg-white rounded-[1rem] border-[1.5px] border-[#101010] overflow-hidden">
                <div className="flex flex-col items-center w-full justify-center py-[2rem] px-[1.5rem]">
                    <div className="w-[100%] flex flex-col max-w-[450px] text-white">
                        ...
                        <form className="w-[100%] flex flex-col gap-[1rem]" onSubmit={handleSubmit}>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col gap-[0.25rem]">
                                    <label className="text-[#1D1D1D] text-[1rem]" htmlFor="firstName">
                                ...
                                <div className="flex flex-col gap-[0.25rem]">
                                    <label className="text-[#1D1D1D] text-[1rem]" htmlFor="lastName">
                            ...
                            <div className="flex flex-col gap-[0.25rem]">
                                ...
                                <input 
                                    ...
                                    minLength={3}
                                />
                                <small className="text-gray-500 text-xs">Username must be at least 3 characters</small>
                            </div>
                            ...
                            <div className="flex flex-col gap-[0.25rem]">
                                <label className="text-[#1D1D1D] text-[1rem]" htmlFor="role">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col gap-[0.25rem]">
                                    ...
                                    <small className="text-gray-500 text-xs">Minimum 6 characters</small>
                                </div>
                                
                                <div className="flex flex-col gap-[0.25rem]">
                                    <label className="text-[#1D1D1D] text-[1rem]" htmlFor="confirmPassword">
                            ...
                            <div className="flex flex-col gap-[0.25rem]">
                                <label className="text-[#1D1D1D] text-[1rem]" htmlFor="phoneNumber">Phone Number</label>
                                <input 
                                    type="tel" 
                                    id="phoneNumber"
                                    name="phoneNumber"
                            ...
                            <div className="flex flex-col gap-[0.25rem]">
                                <label className="text-[#1D1D1D] text-[1rem]" htmlFor="address">Address</label>
                                <input 
                                    type="text" 
                                    id="address"
                                    name="address"
                            ...
                            <button 
                                type="submit" 
                                className="w-[100%] py-[0.6rem] bg-[#FFA00A] text-black hover:text-white ring-[0.5px] ring-black rounded-[0.5rem] text-[1rem] cursor-pointer mt-[0.75rem] hover:bg-black transition-[0.2s] disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={isLoading}
                            >
