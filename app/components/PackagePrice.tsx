...
export default function PackagePrice() {
    return(
        ...
        <div className="grid [grid-template-columns:repeat(auto-fit,minmax(300px,1fr))] gap-8 max-w-[1200px] mx-auto mb-16">
          <div className="bg-gradient-to-br h-[50vh] flex flex-col items-center justify-center from-[#1a1a1a] to-[#111111] rounded-xl p-8 border-2 border-[#333333] relative transition-all duration-300 ease-in-out text-center">
            ...
            <div className="text-center mb-8">
              ...
              <span className="text-5xl font-bold text-[#FFA00A]">5.99</span>
          ...
          <div className="bg-gradient-to-b flex flex-col items-center justify-center from-[#FFA00A] to-[#111111] rounded-xl p-8 border-2 border-[#333333] relative transition-all duration-300 ease-in-out text-center border-[#60a5fa] scale-105 bg-gradient-to-br from-[#1e3a8a] to-[#1a1a1a]">
          ...
          <div className="bg-gradient-to-br flex flex-col items-center justify-center from-[#1a1a1a] to-[#111111] rounded-xl p-8 border-2 border-[#333333] relative transition-all duration-300 ease-in-out text-center">
            ...
            <div className="text-center mb-8">
              <span className="text-2xl text-gray-200 align-top">Rs. </span>
              <span className="text-5xl font-bold text-[#FFA00A]">24.99</span>
              <span className="text-base text-gray-200 ml-2">base rate</span>
            </div>
            <ul className="">
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#111111] rounded-xl p-8 border border-[#333333] max-w-[800px] mx-auto">
          ...
          <div className="grid grid-cols-[1fr_1fr_1fr_auto] gap-4 items-center">
            ...
            <button className="px-6 py-3 bg-[#FFA00A] text-black rounded-md font-semibold cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(37,99,235,0.4)]">Calculate</button>
          </div>
        </div>
      </section>
    )
