...
export default function Services(setIsChatOpen: any) {
    return(
        <section className="bg-[#FFA00A] to-black h-[150vh] flex flex-col items-center justify-center " id="services">
            ...
            <p className="text-[#101010]">Everything you need for hassle-free shipping and delivery</p>
            ...
            <div className="relative h-[55vh] flex flex-col items-center justify-center cursor-pointer overflow-hidden text-center rounded-2xl p-8 border border-[#333333] bg-gradient-to-br from-[#111111] to-[#1a1a1a] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-[#FFA00A] hover:shadow-[0_20px_40px_rgba(96,165,250,0.2)] before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[#FFA00A]/10 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]">
                ...
                <h3 className="text-[30px] font-bold leading-[35px] pb-[15px]">Live Parcel Tracking</h3>
            ...
            <div className="relative h-[55vh] flex flex-col items-center justify-center cursor-pointer overflow-hidden text-center rounded-2xl p-8 border border-[#333333] bg-gradient-to-br from-[#111111] to-[#1a1a1a] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-[#FFA00A] hover:shadow-[0_20px_40px_rgba(96,165,250,0.2)] before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[#FFA00A]/10 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]">
                <div className="service-icon"></div>
                <h3 className="text-[30px] font-bold leading-[35px] pb-[15px]">Estimated Delivery Time</h3>
            ...
            <div className="relative h-[55vh] flex flex-col items-center justify-center cursor-pointer overflow-hidden text-center rounded-2xl p-8 border border-[#333333] bg-gradient-to-br from-[#111111] to-[#1a1a1a] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-[#FFA00A] hover:shadow-[0_20px_40px_rgba(96,165,250,0.2)] before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[#FFA00A]/10 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]">
                <div className="service-icon"></div>
                <h3 className="text-[30px] font-bold leading-[35px] pb-[15px]">Transparent Delivery Costs</h3>
            ...
            <div className="relative h-[55vh] flex flex-col items-center justify-center cursor-pointer overflow-hidden text-center rounded-2xl p-8 border border-[#333333] bg-gradient-to-br from-[#111111] to-[#1a1a1a] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-[#FFA00A] hover:shadow-[0_20px_40px_rgba(96,165,250,0.2)] before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[#FFA00A]/10 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]">
                <div className="service-icon"></div>
                <h3 className="text-[30px] font-bold leading-[35px] pb-[15px]">Smart Package Consolidation</h3>
            ...
            <div className="relative h-[55vh] flex flex-col items-center justify-center cursor-pointer overflow-hidden text-center rounded-2xl p-8 border border-[#333333] bg-gradient-to-br from-[#111111] to-[#1a1a1a] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-[#FFA00A] hover:shadow-[0_20px_40px_rgba(96,165,250,0.2)] before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[#FFA00A]/10 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]">
                <div className="service-icon"></div>
                <h3 className="text-[30px] font-bold leading-[35px] pb-[15px]">Flexible Delivery Options</h3>
            ...
            <div className="relative h-[55vh] flex flex-col items-center justify-center cursor-pointer overflow-hidden text-center rounded-2xl p-8 border border-[#333333] bg-gradient-to-br from-[#111111] to-[#1a1a1a] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:border-[#FFA00A] hover:shadow-[0_20px_40px_rgba(96,165,250,0.2)] before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-[#FFA00A]/10 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]">
                <div className="service-icon"></div>
                <h3 className="text-[30px] font-bold leading-[35px] pb-[15px]">24/7 Customer Support</h3>
