...
export default function WhyChooseUs() {
    return(
        <section className="px-8 py-20 bg-gradient-to-t flex flex-row items-center justify-center from-[#000000] to-[#FFA00A]   border-t border-[#333333]">
        <div className="flex flex-row items-center w-[80vw] space-x-[50px]">
          <h2 className="text-5xl font-bold text-white text-center mb-16">The Sparrow Advantage</h2>
